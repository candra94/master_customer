...
<head>
  ...
  <title>Administrator - Sistem Informasi Customer</title>
  ...
  ?include '../koneksi.php';
  session_start();
  if($_SESSION['status'] != "marketing_logedin"){
...
include '../koneksi.php';
session_start();
// Memeriksa apakah pengguna sudah login dan levelnya adalah marketing
if (!isset($_SESSION['username']) || $_SESSION['level'] != 'marketing') {
    header("Location: ../index.php?alert=belum_login");
    exit();
}
?>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Data</b>Customer</span>
      </a>
